    ...
    '/api/tg/messages/{chatId}/media': {
      post: {
        ...
        requestBody: { content: { 'multipart/form-data': { schema: { type: 'object', properties: {
          ...
          videoNote: { type: 'boolean', description: 'Dumaloq video xabar (kvadrat .mp4/h264 yuboring)' },
          duration: { type: 'integer', description: 'Video/ovoz davomiyligi (sekund) — dumaloq video uchun tavsiya etiladi' },
          width: { type: 'integer', description: 'Dumaloq video tomoni (px, default 384)' },
          height: { type: 'integer', description: 'Dumaloq video tomoni (px, default 384)' },
